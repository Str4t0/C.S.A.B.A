...
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}  Otthoni Tárgyi Nyilvántartó - TELJES INDÍTÁS${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""
...
echo -e "${BLUE}[INFO] Projekt könyvtár: $SCRIPT_DIR${NC}"
echo ""
...
# Indítás
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}  SZOLGÁLTATÁSOK INDÍTÁSA${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""
...
echo -e "${YELLOW}[2/2] Frontend indítása (port 3000)...${NC}"
cd frontend
USE_HTTPS=false nohup npm run dev > ../frontend.log 2>&1 &
FRONTEND_PID=$!
cd ..
...
echo ""
echo -e "${BLUE}================================================${NC}"
echo -e "${GREEN}  SIKERESEN ELINDULT!${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""
